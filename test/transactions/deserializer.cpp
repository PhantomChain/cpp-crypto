...
TEST(transactions, deserialize_transfer)
{
    ...
    Phantom::Crypto::Transactions::Deserializer deserializer("");
...
TEST(transactions, deserialize_second_signature_registration)
{
    ...
    Phantom::Crypto::Transactions::Deserializer deserializer("");
    auto actual = deserializer.deserialize();

    ASSERT_EQ(0xFF, actual.header);
    ASSERT_EQ(1, actual.version);
    ASSERT_EQ(30, actual.network);
    ASSERT_EQ(Phantom::Crypto::Enums::Types::SECOND_SIGNATURE_REGISTRATION, actual.type);
    ...
    const auto publicKey = Phantom::Crypto::Identities::PublicKey::fromHex(actual.senderPublicKey.c_str());
    const auto address = Phantom::Crypto::Identities::Address::fromPublicKey(publicKey, actual.network);
...
TEST(transactions, deserialize_delegate_registration)
{
    ...
    Phantom::Crypto::Transactions::Deserializer deserializer("");
    auto actual = deserializer.deserialize();

    ASSERT_EQ(0xFF, actual.header);
    ASSERT_EQ(1, actual.version);
    ASSERT_EQ(30, actual.network);
    ASSERT_EQ(Phantom::Crypto::Enums::Types::DELEGATE_REGISTRATION, actual.type);
...
TEST(transactions, deserialize_vote)
{
    ...
    Phantom::Crypto::Transactions::Deserializer deserializer("");
    auto actual = deserializer.deserialize();

    ASSERT_EQ(0xFF, actual.header);
    ASSERT_EQ(1, actual.version);
    ASSERT_EQ(30, actual.network);
    ASSERT_EQ(Phantom::Crypto::Enums::Types::VOTE, actual.type);
...
TEST(transactions, deserialize_multi_signature_registration)
{
    ...
    Phantom::Crypto::Transactions::Deserializer deserializer("");
    auto actual = deserializer.deserialize();

    ASSERT_EQ(0xFF, actual.header);
    ASSERT_EQ(1, actual.version);
    ASSERT_EQ(23, actual.network);
    ASSERT_EQ(Phantom::Crypto::Enums::Types::MULTI_SIGNATURE_REGISTRATION, actual.type);
